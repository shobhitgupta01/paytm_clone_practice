    ...
    return(
        <div className="bg-neutral-400 h-screen flex justify-center">
            <div className="bg-white mt-20 h-fit p-10 rounded-lg ">
                ...
                <div className="mb-6"><input className="border border-slate-300 rounded-md w-full h-9" type="text"/></div>
                ...
                <div className="mb-6"><input className="border border-slate-300 rounded-md w-full h-9" type="password"/></div>
